...
export class CdkSqsFairQueuesStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    dashboard.addWidgets(
        new cloudwatch.GraphWidget({
          title: 'Queue backlog for noisy and quiet groups',
          left: [queueApproximateNumberOfMessagesVisisbleMetric, queueApproximateNumberOfMessagesVisibleInQuietGroupsMetric],
          width: 24,
        })
    );
